...
import type { TrelloConfig } from './core/OpenAPI';
...
type HttpRequestConstructor = new (config: TrelloConfig) => BaseHttpRequest;
...
export class TsTrello {
    ...
    constructor(config?: Partial<TrelloConfig>, HttpRequest: HttpRequestConstructor = FetchHttpRequest) {

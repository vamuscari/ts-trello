...
const getHeaders = async (config: Config, options: ApiRequestOptions): Promise<Headers> => {
 ...
 * @throws ApiError
 */
export const request = <T>(config: Config, options: ApiRequestOptions): CancelablePromise<T> => {
